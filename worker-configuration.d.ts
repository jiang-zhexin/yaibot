/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1838db0d457dad9373467717a63e33cd)
// Runtime types generated with workerd@1.20260722.1 2026-06-16 
interface __BaseEnv_Env {
	DB: D1Database;
	BOT_INFO: {"id":7414779700,"is_bot":true,"first_name":"流典忆庭","username":"yet_another_inline_bot","can_join_groups":true,"can_read_all_group_messages":false,"supports_inline_queries":true,"supports_guest_queries":false,"can_connect_to_business":false,"has_main_web_app":false,"has_topics_enabled":false,"allows_users_to_create_topics":false,"can_manage_bots":false,"supports_join_request_queries":false};
	BOT_TOKEN: string;
	WEB_HOOK: string;
	SECRET_TOKEN: string;
	FREEZE: string;
